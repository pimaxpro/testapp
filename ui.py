...
class UIComponent:
    ...
    def render_sidebar(api_service: GeminiAPIService):
        with st.sidebar:
            ...
            # Ô nhập API Key với Material Icon
            ...
            # Cập nhật và lưu lại ngay nếu người dùng nhập mới
            ...
            extra_notes = st.text_area(
                ...
                placeholder="VD: Đánh số câu từ Câu 5, viết lời giải chi tiết...", 
                height=100
            )
    ...
    def render_empty_state():
        # Dùng Material Icon cho trạng thái rỗng
        st.markdown(
            """
